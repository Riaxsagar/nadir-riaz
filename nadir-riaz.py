...
name = raw_input ("\033[91mAp ka Nama ?(RIAZHACKER NAME Real) : ")																	

																	

if name == (""):																	

     print '\x1b[1;92mReal Nama istmal karain RIAZHACKER :V'																	
...
if password == ("riazkhan"):																	
     ...
     print 'Welcome ' + name + ' RIAZHACKER'																	

     time.sleep(0.8)																	

     print 'Semoga beruntung ' + name + ' RIAZHACKER'																	
     ...
     print 'HamiiHacker ' + name + ' Agar Facebook  tools Galat ho gaya  <https://www.facebook.com/Mai Hon tera bap'																	
     ...
     print ("Ap ka Darj kia Gia password Galat ha RIAZHACKER sy help lain (+923188214452)")																	
...
\033[1;96m║\033[1;93m* \033[1;97●♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤༺۝❉FB King❉۝༻♤♤♤♤♤♤♤♤♤♤♤♤♤●																	
